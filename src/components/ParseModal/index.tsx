...
export function ParseModal({
  ...
  return (
    ...
    >
      <div className="fade-in bg-white rounded-[16px] w-full max-w-[520px] shadow-[0_24px_64px_rgba(0,0,0,0.22)] overflow-hidden">
        <div className="p-[20px_22px_18px] border-b border-slate-200 flex items-start justify-between">
          ...
          <button
            onClick={onClose}
            className="bg-transparent border-none cursor-pointer text-slate-400 p-[6px] rounded-[6px] flex items-center shrink-0"
          >
            <svg
              width="15"
              height="15"
        ...
        <div className="p-[20px_22px]">
          ...
          <input
            ...
            className={`w-full px-[12px] py-[10px] rounded-[8px] text-[13px] text-slate-900 outline-none transition-[border-color,background] duration-150 ${
              showError
                ? 'border-[1.5px] border-red-200 bg-red-50'
                : valid && touched
                  ? 'border-[1.5px] border-green-200 bg-slate-50'
          ...
          <div className="mt-[12px] p-[10px_12px] bg-slate-50 border border-slate-200 rounded-[8px] flex items-start gap-[8px]">
            <svg
              width="13"
              height="13"
          ...
          <div className="mt-[10px] flex items-center gap-[7px]">
            ...
            <button
              ...
              className="bg-transparent border-none p-0 text-[11.5px] text-blue-500 cursor-pointer underline"
            >
        ...
        <div className="p-[14px_22px] border-t border-slate-200 flex justify-end gap-[8px]">
          ...
          <button
            ...
            className={`px-[20px] py-[8px] rounded-[8px] text-[13px] font-semibold border-none flex items-center gap-[7px] transition-[background] duration-150 ${
              valid && !isLoading
