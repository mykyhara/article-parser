...
export function LeftPanel({
  ...
  return (
    <aside className="w-[36%] min-w-[300px] max-w-[420px] overflow-y-auto p-[18px_14px_18px_20px] border-r border-slate-200 bg-slate-50 flex flex-col">
      ...
      {error && (
        <div className="p-[14px_16px] bg-red-50 border border-red-200 rounded-[10px] text-[13px] text-red-800 mb-[10px]">
          <p className="font-semibold mb-1">Failed to parse document</p>
          <p className="text-red-900 text-[12px] leading-[1.5] mb-2">
            {error.message}
          </p>
          <button
            onClick={onOpenParse}
            className="bg-transparent border-0 cursor-pointer text-[12px] text-red-600 underline p-0"
          >
            Try again
          </button>
        </div>
      ...
      {!article && !isLoading && !error && (
        <div className="flex-1 flex flex-col items-center justify-center gap-[20px] p-[24px_8px]">
          ...
          <div className="text-center">
            <p className="text-[14px] font-semibold text-slate-600 m-0 mb-[6px]">
              Quality checks
            </p>
